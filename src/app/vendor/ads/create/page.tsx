        ...
        <div className="max-w-2xl">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-xl rounded-2xl border border-slate-700/50 p-6 space-y-6">
              ...
              <div>
                <label className="block text-sm font-medium text-slate-300 mb-2">Ad Media (image or video)</label>
                <div
                ...
                >
                  {imagePreview ? (
                    <div className="relative">
                      {previewIsVideo || imageUrl.includes('/video/upload/') || /\.(mp4|webm|mov|m4v)(\?|$)/i.test(imageUrl) ? (
                        <video src={imagePreview || imageUrl} className="max-h-48 mx-auto rounded-xl object-contain" controls muted playsInline />
                      ) : (
                    ...
                    <div className="py-8">
                      ...
                      <p className="text-slate-400 text-sm">Click to upload image or video</p>
                      <p className="text-slate-500 text-xs mt-1">JPG, PNG, WebP, MP4, WebM (max 50MB)</p>
                    </div>
                  )}
                  <input
                    ref={fileInputRef}
